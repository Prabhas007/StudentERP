...
function FeedbackForm() {
    ...
    const feedback_type = {
        'qos': 'Please rate the quality of the Content you received from your Faculty.', 
        'qob': 'Please rate the quality of your subject.',
        'roc': 'Doubts were cleared by the faculty',
        'exp': 'Overall rating'
    };
    ...
    return (
        <Container>
            {displayform ? 
            (<Card style={{ width: '100rem' , height: '80rem'}}>
                 
                <Card.Header>
                
                    <cite title="Source Title">Student Feedback Form </cite>
